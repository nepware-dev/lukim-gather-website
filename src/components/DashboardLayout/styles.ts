export default {
  ...
  sideBar:
    "fixed w-[236px] h-[100%] px-[20px] bg-[#F2F5F9] border-r border-[#CCDCE8]",
  ...
  count:
    "w-[24px] h-[19px] flex items-center justify-center ml-auto text-[12px] font-inter bg-[#E6EEF3] rounded-full",
  mobileHeader:
    "md:hidden w-full p-4 flex items-center justify-between border-b border-[#CEDCEC]",
