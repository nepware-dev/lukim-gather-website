export default {
  ...
  wrapper: 'min-h-full w-[434px] bg-color-white px-[20px] py-[28px] overflow-y-scroll',
  header: 'mb-[24px] flex w-full justify-between items-center pt-4',
  ...
  surveyTitle: 'font-interSemibold text-[24px] text-color-text max-w-[355px] px-2 py-1 rounded mb-[-8px]',
