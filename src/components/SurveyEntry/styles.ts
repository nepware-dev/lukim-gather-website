export default {
  ...
  headerWrapper: 'sticky top-0 pt-[28px] pb-[12px] bg-color-white px-[18px] z-10 h-[80px]',
  headerWrapperBackground: 'z-0',
  versionTabsContainer: 'sticky top-[80px] z-10 bg-[#fff] flex items-center px-[18px] pb-[12px] gap-5 pt-[8px] overflow-x-auto w-full border-b-[1px] border-[#B6CBE3]',
  versionTabsContainerBackground: 'z-0',
