export default {
  container:
    "absolute top-[45px] rounded-lg shadow-[0_4px_42px_rgba(0,5,40,0.16)] z-20 md:right-[2em]",
  notificationWrapper:
    "flex p-[10px] rounded-lg hover:bg-[#F0F3F6] cursor-pointer mb-1",
  ...
  itemWrapper:
    "w-[338px] bg-color-white z-auto px-[16px] py-[12px] rounded-lg right-0 max-h-[75vh] overflow-y-auto",
