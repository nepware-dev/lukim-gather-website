  ...
  return (
    <main className='bg-color-bg w-[100%] h-screen grid'>
      <div className='place-self-center bg-color-white px-8 py-10 w-fit rounded-3xl w-96'>
        <h2 className='text-color-blue text-center font-inter font-semibold text-2xl'>Welcome back</h2>
        <p className='text-color-blue text-center font-inter font-normal text-lg mb-10'>Please enter your details.</p>
        ...
        <input
          ...
          className='w-[100%] rounded-lg p-2 border border-color-border font-normal'
        />
        ...
        <input
          ...
          className='w-[100%] rounded-lg p-2 border border-color-border'
        />
