export default {
  ...
  heroContent: 'lg:w-[50%]',
  heroTitle: 'leading-[44px] -tracking-[0.025px] text-[36px] font-interSemibold text-color-blue sm:leading-[68px] sm:text-[64px]',
  ...
  backgroundTitle: 'font-interSemibold text-[36px] leading-[44px] text-color-blue mt-[50px] mb-[56px] lg:mt-[0] lg:text-center sm:text-[48px] sm:leading-[62px]',
  ...
  appInfoTitle: 'font-interSemibold text-[32px] text-color-text leading-[42px] mb-[64px]',
