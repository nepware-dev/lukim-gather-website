...
const classes = {
  ...
  heroContent: 'lg:w-[50%]',
  heroTitle: 'font-sans font-[700] leading-[44px] text-[36px] text-color-blue sm:leading-[68px] sm:text-[64px]',
  heroText: 'font-inter font-[400] text-[16px] leading-[24px] text-color-text my-[28px] sm:text-[18px] sm:leading-[26px]',
  heroInfo: 'font-inter font-[600] text-[16px] text-color-text leading-[24px] sm:text-[18px] sm:leading-[26px]',
  ...
  backgroundTitle: 'font-sans font-[700] text-[36px] leading-[44px] text-color-blue mt-[50px] mb-[56px] lg:mt-[0] lg:text-center sm:text-[48px] sm:leading-[62px]',
  ...
  bgInfo: 'font-inter font-[400] text-[16px] leading-[24px] text-color-text sm:text-[18px] sm:leading-[32px]',
  highlightText: 'text-color-green-alt',
  bgCards: 'flex flex-col gap-[10px]',
  appInfoWrapper: 'px-[5vw] py-[50px] lg:py-[0] lg:absolute lg:-bottom-[136px] lg:left-0 lg:right-0',
  appInfoTitle: 'font-sans font-[700] text-[32px] text-color-text leading-[42px] mb-[64px]',
  ...
  appInfo: 'max-w-[930px] mx-auto font-inter font-[400] text-[16px] leading-[24px] text-color-text sm:text-[18px] sm:leading-[32px]',
  ...
  formTitle: 'max-w-[320px] font-sans font-[700] text-[36px] leading-[44px] text-color-green-alt sm:text-[48px] sm:leading-[52px]',
  formText: 'font-inter font-[400] text-[16px] leading-[24px] text-color-white sm:text-[18px] sm:leading-[32px]',
