...
const classes = {
  ...
  heroContent: 'lg:w-[50%]',
  heroTitle: 'leading-[44px] text-[36px] text-color-blue sm:leading-[68px] sm:text-[64px]',
  ...
  backgroundTitle: 'font-sans text-[36px] leading-[44px] text-color-blue mt-[50px] mb-[56px] lg:mt-[0] lg:text-center sm:text-[48px] sm:leading-[62px]',
  ...
  appInfoTitle: 'font-sans text-[32px] text-color-text leading-[42px] mb-[64px]',
  ...
  formTitle: 'max-w-[320px] font-sans text-[36px] leading-[44px] text-color-green-alt sm:text-[48px] sm:leading-[52px]',
