export default {
  ...
  seperator: 'border-[1px] border-[#E7E8EA] h-[44px]',
  ...
  website: 'flex items-center gap-2 max-w-fit text-base font-medium text-[#282F3E]',
  ...
  userHeader: 'font-semibold olor-[#404653]',
  userItem: 'flex flex-row items-center',
  nameInitial: 'flex justify-center items-center bg-[#5486BD] text-[#fff] inline rounded-3xl mr-4 w-8 h-8',
  ...
  orgLogo: 'w-16',
  orgName: 'pl-8 text-[#0A52A1] font-semibold font-meium',
};
